...
from classification.models.models.helpers import build_model_with_cfg
from classification.models.models.layers import PatchEmbed, Mlp, DropPath, to_2tuple, trunc_normal_
from classification.models.models.registry import register_model
from classification.models.models.layers import _assert
...
class CoaT(nn.Module):
    ...
    def __init__(
            self, img_size=224, patch_size=16, in_channels=3, num_classes=1000, embed_dims=(0, 0, 0, 0),
