...
from classification.models.models.helpers import build_model_with_cfg, checkpoint_seq
from classification.models.models.layers import PatchEmbed, Mlp, DropPath, trunc_normal_
...
class Cait(nn.Module):
    ...
    def __init__(
            self, img_size=224, patch_size=16, in_channels=3, num_classes=4, global_pool='token',
